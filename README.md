...
5. В файле config.txt меняем значения на свои. Можно обойтись без использования файла config.txt. До компиляции в строках 28-29 BotToken и Chat_IDint вписать свои значения
